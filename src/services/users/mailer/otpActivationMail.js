...
const sendMail = (recvEmailAddr, lang, tokenString) => {
  // console.log({recvEmailAddr, lang, tokenString});
  var mailSubject = '[Arena wave] Please verify your email address.';

  let filename = './mailhtmlbody/' + 'initial_registration.html';
  let mailbodyhtml = getMailBody(filename);
  
  let confirmUrl = mailProperty.otpActivation.baseurl + mailProperty.otpActivation.confirmUri + tokenString;
