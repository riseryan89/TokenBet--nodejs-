...
const sendMail = (recvEmailAddr, lang, tokenString) => {
  var mailSubject = '[Arenawave.io]Please verify your email address.';

  let filename = './mailhtmlbody/' + 'initial_registration.html';
  let mailbodyhtml = getMailBody(filename);
  
  let confirmUrl = mailProperty.activation.baseurl + mailProperty.activation.confirmUri + tokenString;
